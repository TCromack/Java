 ...
 * Problem Number: HW#5 Complex Numbers GUI2
 * The Driver for the Complex Class
 */
import javax.swing.JOptionPane;
 
public class ComplexGui2
{
     private final static String TITLE = "Complex Number Driver V2.5";
    ...
    private static Complex buildComplex (String prompt)
    {
        ...
        if (result == JOptionPane.OK_OPTION)
        {
            ...
            {
                complex = new Complex(cip.getComplex());
            }
            else
            {
